...
-- Crear función que devuelve estudiantes del padre con info de ruta
...
IS 'Obtiene estudiantes del padre autenticado con información de parada y ruta, evitando recursión RLS';
